 ...
 * @head: head node to address of pointer
 * @str: field of str node
...
/**
 * print_list_str - the str element of a list_t linked list are only printed
...
/**
 * delete_node_at_index - node at given index are deleted
 * @head: the first node to address of pointer
